...
//    }
    ...
    fun doingStuffsWithGeneralLookup() {
        ...
        scenarioRepo.save(scenario1)
        // test 2
//        scenarioRepo.deleteAttributesById(scenario1.id!!.id)
//        println("attributes: ${scenario1.attributes}")
//        scenario1.attributes = listOf(item2.id!!.asScenarioAttributeValueId)
//        scenarioRepo.save(scenario1)
        // test 3
//        scenarioRepo.delete(scenario1)
        //println("attributes ${scenario1.attributes!!.map { it.id }}")
    }
}
